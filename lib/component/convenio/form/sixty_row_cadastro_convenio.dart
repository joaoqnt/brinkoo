...
class SixtyRowCadastroConvenio extends StatelessWidget {
  final CadastroConvenioController controller;

  const SixtyRowCadastroConvenio({
    super.key,
      ...
      children: [
        ResponsiveField(
          child: CustomTextFormField(
            labelText: "Quantidade Crianças Visitas",
            controller: controller.tecQtdVisita,
            prefixIcon: Icon(Icons.format_list_numbered),
          ),
        ),
        ResponsiveField(
          child: CustomTextFormField(
            labelText: "Valor  Pago do Convênio",
            controller: controller.tecValorConvenio,
        ...
        ResponsiveField(
          child: CustomTextFormField(
            labelText: "Desconto Empresa",
            controller: controller.tecValorEmpresa,
            keyboardType: TextInputType.number,
            prefixIcon: Icon(Icons.money),
            inputFormatters: [
              FilteringTextInputFormatter.digitsOnly,
