...
part of 'atividade_list_controller.dart';
...
mixin _$AtividadeListController on _AtividadeListController, Store {
  late final _$isLoadingAtom = Atom(
    name: '_AtividadeListController.isLoading',
    context: context,
  );
  ...
  late final _$atividadesAtom = Atom(
    name: '_AtividadeListController.atividades',
    context: context,
  );
